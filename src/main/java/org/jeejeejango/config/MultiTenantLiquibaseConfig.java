...
import org.jeejeejango.mt.MultiTenantDataSources;
import org.jeejeejango.mt.MultiTenantLiquibase;
import org.jeejeejango.mt.MultiTenantProperties;
...
public class MultiTenantLiquibaseConfig {
    ...
    public MultiTenantLiquibaseConfig(MultiTenantProperties multiTenantProperties,
                                      ...
                                      MultiTenantDataSources multiTenantDataSources,
    ...
    public void checkChangelogExists() {
        if (this.liquibaseProperties.isCheckChangeLogLocation()) {
            Resource resource = this.resourceLoader
                .getResource(this.liquibaseProperties.getChangeLog());
    ...
    public MultiTenantLiquibase multiTenantLiquibase() {
        ...
        multiTenantLiquibase.setDatabaseChangeLogTable(
            this.liquibaseProperties.getDatabaseChangeLogTable());
        multiTenantLiquibase.setDatabaseChangeLogLockTable(
